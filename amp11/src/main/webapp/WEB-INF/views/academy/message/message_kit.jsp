					        ...
					        <%for(int i=0;i<list.size();i++){ %>
					        	...
					        	<li class='clearfix'>
						        	<div class='message-data align-right'><span class='message-data-time' ><%=list.get(i).getDate() %></span> &nbsp; </div>				            
			         				 <div class='message my-message float-right' > <%= list.get(i).getCon()%></div><div style="float:right;"><%=list.get(i).getView_count() %></div> 
		         				 </li>
					        	<%}else{ %>
					        	<li class='clearfix'><div class='message-data'> 
							          ...
							          <div class='message  other-message float-left'> <%= list.get(i).getCon()%></div><div style="float: left"><%=list.get(i).getView_count() %></div> 
						        </li>
					        	<%} %>
					        <%} %>
	        			</ul>
